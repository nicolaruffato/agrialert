...
public class FieldsListFragment extends Fragment
    ...
    private void showFields() {
        ...
        btnFields.setChecked(true);
        btnFieldGroups.setChecked(false);
        btnAddField.setText("Add a new field");
    ...
    private void showGroups() {
        ...
        btnAddField.setText("Add a new group");
                ...
                groups -> {
                    ...
                    for (GroupWithFields g : groups) {
                        uiList.add(new GroupUiModel(
                                0, // TODO: replace with real ID if necessary
                                g.getGroup().getName(),
    ...
    /**
     * Creates a list of sample groups for testing purposes.
     *
     * @return A list of sample GroupUiModel objects.
     */
